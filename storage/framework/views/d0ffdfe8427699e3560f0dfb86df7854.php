...
<main class="inquiry-page" id="main">
    <div class="inquiry-container">
        ...
        <?php if(session('submission')): ?>
            <div class="inquiry-result"><div class="state-panel state-panel--success"><h2>Inquiry received</h2><p><?php echo e(session('submission.message')); ?></p><p><strong>Reference:</strong> <span class="reference-code"><?php echo e(session('submission.reference')); ?></span></p></div></div>
        <?php else: ?>
        <form class="inquiry-form" action="<?php echo e(route('inquiries.store', $type)); ?>" method="post" enctype="multipart/form-data" novalidate data-inquiry-form>
            ...
            <fieldset class="inquiry-step" data-step="<?php echo e($loop->index); ?>" <?php if(!$loop->first): ?> hidden <?php endif; ?>>
                <legend><?php echo e($step['title']); ?></legend><p class="inquiry-step-description"><?php echo e($step['description']); ?></p>
