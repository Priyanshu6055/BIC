        ...
        <?php if(session('submission')): ?>
            <div class="inquiry-result">
                <div class="state-panel state-panel--success">
                    ...
                    <p><?php echo e(session('submission.message')); ?></p>
                    <p><strong>Reference:</strong> <span class="reference-code"><?php echo e(session('submission.reference')); ?></span></p>
                    <p style="margin-top: 24px;"><a class="button button--primary" href="<?php echo e(route('home')); ?>">Back to Home</a></p>
                </div>
            </div>
        <?php else: ?>
