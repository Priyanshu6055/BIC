    ...
    <div class="admin-header-top">
        ...
        <div class="admin-header-actions">
            <div class="admin-export-group">
                <a href="<?php echo e(route('admin.inquiries.export', array_merge(request()->query(), ['format' => 'csv']))); ?>" class="admin-btn-export" title="Download filtered inquiries to Excel (.csv)">
