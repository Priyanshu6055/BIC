<?php $__env->startSection('title', 'Change Password | BIC Administration'); ?>
...
<div style="max-width: 680px;">
    <?php if(session('success')): ?>
        <div class="admin-alert admin-alert-success" role="alert" style="margin-bottom: 24px; padding: 16px 20px; background: rgba(34, 197, 94, 0.1); border: 1px solid rgba(34, 197, 94, 0.3); border-radius: 8px; color: #166534; display: flex; align-items: flex-start; gap: 12px;">
            ...
            <div>
                ...
                <span style="font-size: 13px;"><?php echo e(session('success')); ?></span>
            </div>
        </div>
    <?php endif; ?>
    ...
    <form class="admin-form-card" method="post" action="<?php echo e(route('admin.password.update')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="admin-form-actions" style="margin-top: 28px; display: flex; gap: 12px;">
            ...
            <a href="<?php echo e(route('admin.inquiries.index')); ?>" class="admin-btn-cancel">Cancel</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DESIGN\Downloads\BIC_Laravel_Production_Source\resources\views/admin/password/edit.blade.php ENDPATH**/ ?>