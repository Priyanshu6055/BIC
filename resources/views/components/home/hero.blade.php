<section class="hero-track">
    <div class="hero">
        <div class="hero-grid"><div>
            <div class="eyebrow">Bridge India Capital · Strategic Capital Infrastructure</div>
        ...
        <div class="portal" aria-hidden="true"><div class="portal-inner">
            <svg class="portal-scene" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice">
                <rect width="1600" height="900" fill="var(--primary)"></rect>
                <g fill="none" stroke="rgba(255,255,255,.54)" stroke-width="2">
                    <path d="M0 730 C210 540 410 710 620 500 S1030 450 1280 250 1510 250 1600 180"></path>
                    <path d="M0 805 C270 675 480 790 700 620 S1110 570 1600 520"></path>
                    <path d="M100 730 L330 510 L560 615 L785 355 L1000 520 L1220 255 L1500 375"></path>
                </g>
                <g fill="var(--accent)"><circle cx="330" cy="510" r="12"></circle><circle cx="785" cy="355" r="14"></circle><circle cx="1220" cy="255" r="12"></circle></g>
