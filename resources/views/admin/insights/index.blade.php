                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        <div style="display: inline-flex; align-items: center; justify-content: flex-end; gap: 8px;">
                            <a href="{{ route('admin.insights.edit', $insight) }}" class="admin-btn-action-edit" title="Edit insight">
                                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>
                                <span>Edit</span>
                            </a>
                            <form method="POST" action="{{ route('admin.insights.destroy', $insight) }}" onsubmit="return confirm('Are you sure you want to delete this insight: &quot;{{ addslashes($insight->title) }}&quot;? This action cannot be undone.');" style="display: inline; margin: 0;">
                                @csrf
                                @method('DELETE')
